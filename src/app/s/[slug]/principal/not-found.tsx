...
export default function PrincipalNotFound() {
  return (
    <div className="flex min-h-screen flex-col items-center justify-center gap-4 bg-[var(--color-background)] p-6 text-center">
      ...
      <p className="max-w-md text-sm text-[var(--color-text-secondary)]">
        Try a demo school such as{' '}
        <Link href="/s/green-valley/principal" className="font-medium text-[var(--color-primary)] hover:underline">
          green-valley
        </Link>
        .
      </p>
